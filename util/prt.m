...
case{'sar_bma_g'} 
if arg == 1
     prt_sar_bma_g(results);
     elseif arg == 2
     prt_sar_bma_g(results,vnames);
     elseif arg == 3
     prt_sar_bma_g(results,vnames,fid);
     else
     prt_sar_bma_g(results,[],fid);
   end;
...
case {'sarq'}
     ...
     prt_sar_old(results);
     elseif arg == 2
     prt_sar_old(results,vnames);
     elseif arg == 3
     prt_sar_old(results,vnames,fid);
     else
     prt_sar_old(results,[],fid);
     end;
