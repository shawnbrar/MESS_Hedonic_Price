...
beta1 = result1.bdraw(:,2);
beta2 = result2.bdraw(:,2);

beta_diff = beta2 - beta1;

[h1,f1,y1] = pltdens(beta1);
[h2,f2,y2] = pltdens(beta2);
...
subplot(2,1,2),
plot(y3,f3,'.-g');
ylabel('Posterior for \beta_2 - \beta_1');
xlabel('\beta_2 - \beta_1 values');
zipi = find(y3 > 0);
line([0 0],[0 f3(zipi(1,1))]);
legend('\beta_2 - \beta_1','zero');
