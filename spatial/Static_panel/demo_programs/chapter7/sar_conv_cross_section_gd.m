...
y = (speye(n*t) - rho*Wc)\(ones(n,1)*2 + x*beta + evec);
...
result1 = sar_conv_panel_g(y,[ones(n,1) x],Wmatrices,n,t,ndraw,nomit,prior);
vnames = strvcat('y','constant','x1','x2');
prt_panel(result1,vnames);


result2 = sar_conv_panel_bma_g(y,[ones(n,1) x],Wmatrices,n,t,ndraw,nomit,prior);
vnames = strvcat('y','constant','x1','x2');
